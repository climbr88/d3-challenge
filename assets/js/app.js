...
// Import Data
d3.csv("assets/data/state_data.csv").then(function(stateData) {

  console.log(stateData)
    // Step 1: Parse Data/Cast as numbers
    // ==============================
    stateData.forEach(function(data) {
      data.obesity_rate = +data.obesity;
      data.poverty_rate = +data.poverty;
    });

    // Step 2: Create scale functions
    // ==============================
    var xLinearScale = d3.scaleLinear()
      .domain([20, d3.max(stateData, d => d.obesity_rate)])
      .range([0, width]);

    var yLinearScale = d3.scaleLinear()
      .domain([0, d3.max(stateData, d => d.poverty_rate)])
      .range([height, 0]);
